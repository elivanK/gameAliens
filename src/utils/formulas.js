//To avoid repeating similar template literals
//Add function that returns this string based on some parameters
export const pathFromBezierCurve = (cubicBezierCurve) => {
  ...
  /*
The atan function, provided by the Math JavaScript object, returns results 
in radians. You will need this value converted to degrees. 
That's why you have to define (and use) the radiansToDegrees function.
  */
